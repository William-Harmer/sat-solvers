...
//    public static LinkedHashMap<Character, Boolean> uPAndBF(ArrayList<ArrayList<Character>> clauses){
...
//
//        LinkedHashMap<Character, Boolean> satAssignment = uPAndBF(clauses);
